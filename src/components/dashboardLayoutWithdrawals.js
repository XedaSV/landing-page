...
import WithdrawalUnconfirmTable from "./WithdrawalUnconfirmTable";
import { useState ,useEffect} from 'react';
import { Link ,useNavigate,useParams} from "react-router-dom";
import api from '../api/defaultRequest';

function DashboardLayoutWithdrawals() {
 ...
 useEffect(() => {
   ...
   fetchData();
    ...
    export default DashboardLayoutWithdrawals;